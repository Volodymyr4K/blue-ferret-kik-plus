...
const siteContent: SiteContent = {
  ...
  about: {
    title: 'Хто ми',
    subtitle: 'Видавництво з характером',
    intro: 'Blue Ferret — це не просто видавництво. Це простір, де настільні ігри створюються з любов\'ю до гри, з власним характером і атмосферою, яку відчуває кожен гравець.',
  ...
  pillars: [
    ...
    { title: 'Відкривайте ігри', description: 'Каталог настільних ігор Blue Ferret. Кожна гра — окремий світ з власним характером, механікою та атмосферою.', href: '/igry', icon: 'gamepad' },
