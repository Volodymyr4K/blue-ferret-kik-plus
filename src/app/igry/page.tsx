          ...
          <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-8 lg:gap-9">
            {games.map((game, i) => (
              ...
              >
                <Link
                  href={`/igry/${game.slug}`}
                  className="group flex h-full flex-col bg-white rounded-2xl sm:rounded-3xl overflow-hidden board-game-border transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_28px_46px_-30px_rgba(15,23,42,0.45)]"
                >
                  <div
