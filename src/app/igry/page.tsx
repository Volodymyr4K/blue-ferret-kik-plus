            ...
            {games.map((game, i) => {
              ...
              return (
                ...
                >
                  {isComingSoon ? (
                    <div
                      className="group relative flex h-full flex-col bg-white rounded-2xl sm:rounded-3xl overflow-hidden board-game-border transition-all duration-300 cursor-not-allowed"
                      aria-disabled="true"
                    >
                      <div
                      ...
                      <div className="p-5 sm:p-7 lg:p-8 flex flex-col h-full">
                        <h2 className="text-lg sm:text-2xl lg:text-[1.8rem] font-bold transition-colors duration-300 mb-3 sm:mb-4 tracking-tight text-slate-800">
                          {game.name}
                        </h2>
